...
//             // return omni_sendtrade(values); FIXME!
//         }
...
//             values.push_back(request.params[3]); // propertyIdDesired
//             values.push_back(request.params[4]); // amountDesired
//             // return omni_sendcanceltradesbyprice(values); FIXME!
//         }
...
//             values.push_back(request.params[1]); // propertyIdForSale
//             values.push_back(request.params[3]); // propertyIdDesired
//             // return omni_sendcanceltradesbypair(values);FIXME!
//         }
...
//             // return omni_sendcancelalltrades(values); FIXME!
//         }
//     }
//
...
{ //  category                             name                            actor (function)               okSafeMode
  //  ------------------------------------ ------------------------------- ------------------------------ ----------
    ...
    // { "omni layer (transaction creation)", "omni_senddexsell",             &omni_senddexsell,              {} },
    ...
    // { "omni layer (transaction creation)", "omni_sendcanceltradesbyprice", &omni_sendcanceltradesbyprice,  {} },
    // { "omni layer (transaction creation)", "omni_sendcanceltradesbypair",  &omni_sendcanceltradesbypair,   {} },
    // { "omni layer (transaction creation)", "omni_sendcancelalltrades",     &omni_sendcancelalltrades,      {} },
    // { "omni layer (transaction creation)", "omni_sendsto",                 &omni_sendsto,                  {} },
    ...
    // { "omni layer (transaction creation)", "omni_sendenablefreezing",      &omni_sendenablefreezing,       {} },
    // { "omni layer (transaction creation)", "omni_senddisablefreezing",     &omni_senddisablefreezing,      {} },
    // { "omni layer (transaction creation)", "omni_sendfreeze",              &omni_sendfreeze,               {} },
    // { "omni layer (transaction creation)", "omni_sendunfreeze",            &omni_sendunfreeze,             {} },
    ...
    //
    // /* depreciated: */
    // { "hidden",                            "sendrawtx_MP",                 &omni_sendrawtx,                {} },
    // { "hidden",                            "send_MP",                      &omni_send,                     {} },
    // { "hidden",                            "sendtoowners_MP",              &omni_sendsto,                  {} },
    // { "hidden",                            "trade_MP",                     &trade_MP,                      {} },
#endif
};
